...
<div class="wrapper">
  ...
  <header class="main-header">
    <a href="<?= base_url() . $this->session->logged_in_user->type ?>" class="logo">
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?= $this->session->logged_in_user->full_name ?></span>
            </a>
            <ul class="dropdown-menu">
              <li class="user-header">
                ...
                <p>
                  <?= $this->session->logged_in_user->full_name ?>
                  <small id="membershipDate"></small>
                </p>
              </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?= $this->session->logged_in_user->full_name ?></p>
